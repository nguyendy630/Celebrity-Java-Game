...
public class CelebrityPanel extends JPanel
{
  ...
  public CelebrityPanel(CelebrityGame controller)
  {
    ...
    this.sport = new JTextArea(controller.sendSport(), 30, 20);
    this.country = new JTextArea(controller.sendCountry(), 30, 20);
  ...
  private void setupPanel()
  {
    ...
    sport.setLineWrap(true);
    country.setLineWrap(true);
  ...
  private void setupLayout()
  {
    ...
    // Athlete GUI
    panelLayout.putConstraint(SpringLayout.NORTH, sport, 15, SpringLayout.NORTH, this);
    panelLayout.putConstraint(SpringLayout.WEST, sport, 15, SpringLayout.WEST, this);
    panelLayout.putConstraint(SpringLayout.SOUTH, sport, -100, SpringLayout.SOUTH, this);
    panelLayout.putConstraint(SpringLayout.EAST, sport, -15, SpringLayout.EAST, this);
    panelLayout.putConstraint(SpringLayout.NORTH, country, 15, SpringLayout.NORTH, this);
    panelLayout.putConstraint(SpringLayout.WEST, country, 15, SpringLayout.WEST, this);
    panelLayout.putConstraint(SpringLayout.SOUTH, country, -100, SpringLayout.SOUTH, this);
    panelLayout.putConstraint(SpringLayout.EAST, country, -15, SpringLayout.EAST, this);
  ...
  private void updateScreen()
  {
    ...
    else
    {
      ...
      clueArea.append(controller.sendCountry());
      clueArea.append(controller.sendSport());
    }
